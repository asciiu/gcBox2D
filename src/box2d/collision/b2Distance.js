...
var b2Distance = exports = Class(function() {
	...
	this.g_GJK_Iterations = 0;
 	...
 	this.ProcessTwo = function(p1Out, p2Out, p1s, p2s, points){
	...
	this.ProcessThree = function(p1Out, p2Out, p1s, p2s, points){
		//b2Vec2 a = points[0];
		var aX = points[0].x;
		var aY = points[0].y;
		//b2Vec2 b = points[1];
	...
	this.InPoinsts = function(w, points, pointCount){
	...
	this.Distance = function(p1Out, p2Out, shape1, shape2){
		//b2Vec2 p1s[3], p2s[3];
		var p1s = new Array(3);
		var p2s = new Array(3);
		//b2Vec2 points[3];
